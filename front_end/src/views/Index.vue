    ...
    <div :style="state.style" class="top-nav">
      <div class="top-nav-wrap">
        ...
        <HeaderOptions ref="optionsRef" v-model="state.isContinue" @change="optionsChange">
          ...
          <el-button ref="ref4" size="large" class="primary-btn" type="primary" @click="dealWith('downloadFrontend')">{{ $t('header.download') }}</el-button>
        </HeaderOptions>
      </div>
    </div>
...
const fns: any = {
  ...
  downloadFrontend: () => {
    optionsRef.value?.downloadFrontend()
  },
  changeLineGuides,
  newDesign: () => {
